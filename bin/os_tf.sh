...
aws s3 cp "s3://kubenow-us-east-1/$kubenow_image_name".qcow2 s3://kubenow-eu-frankfurt/ --region us-east-1 --acl public-read
aws s3 cp "s3://kubenow-us-east-1/$kubenow_image_name".qcow2.md5 s3://kubenow-eu-frankfurt/ --region us-east-1 --acl public-read
